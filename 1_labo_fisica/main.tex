...
\begin{itemize}
   \item Usamos el nivel el para nivelar el plano de los rieles
   \item Marcamos los punto $A_0, A_1 , A_2 , A_3 , A_4$ en intervalos de 10cm en la cinta que esta colocada en el riel
   \item Medimos las dimensiones de la rueda de Maxwell con el pie de rey
   \item Medimos el diámetro de su eje cilíndrico y de ahí obtenemos el radio
   \item Colocamos la rueda de Maxwell en la posición $A_0$, para luego soltarla y medir con ello el tiempo $t_1,t_2, t_3,t_4$ que demora en recorrer los intervalos $A_0 A_1, A_1 A_2 , A_2 A_3 , A_3 A_4$ de forma consecutiva.
   \item Tomamos tres mediciones para $A_0 A_1, A_0 A_2, A_0 A_3$ y diez mediciones $A_0 A_4$.
   \item Medimos la masa de la rueda de Maxwell y las alturas en las posiciones $G_{\mathrm{d}}$ y $G_4$ para hallar su diferencia.
   \item Una vez completado los pasos anteriores, colocamos en otra posición el nuevo $G_0$ y el nuevo $G_4$, pero evitando que la rueda deslice sobre los rieles.
   \item nuevamente volvemos a medir solamente el tiempo que demora en recorrer intervalo $A_0 A_4$ diez veces.
   \item Medimos nuevamente la diferencia entre el nuevo $G_{\mathrm{d}}$ y $G_4$.
   \item Recopilamos los datos del experimento de la rueda de Maxwell para poder realizar los cálculos.
\end{itemize}
...
Diámetro del eje de la rueda de maxwell: $\mathrm{D}_{\mathrm{ojo}}=5.05 \mathrm{~mm}$,
Altura 1: $\mathrm{h}_1=57.5 \mathrm{~mm}$
Incertidumbre del vernier: $\Delta=0.03 \mathrm{~mm}$
Masa de la rueda de maxwell: $\mathrm{M}=481.1 \mathrm{~g}, \Delta \mathrm{M}=0.1 \mathrm{~g}$

Tabla 2: Datos tomados en el laboratorio
Alumno 1:
Experimento 1:
Estos datos fueron recogidos respecto a una altura inicial $h_0=57.5 \mathrm{~mm}$
\begin{tabular}{|c|c|c|c|c|}
\hline & T1 & T2 & T3 & Tprom \\
\hline$A_0 A_1$ & 6.20 & 6.23 & 6.36 & 6.26 \\
\hline$A_0 A_2$ & 8.91 & 8.91 & 9.13 & 8.98 \\
\hline$A_0 A_3$ & 10.88 & 10.89 & 11.18 & 10.98 \\
\hline$A_0 A_4$ & 12.71 & 12.71 & 12.92 & 12.78 \\
\hline
\end{tabular}
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline & T1 & T2 & T3 & T4 & T5 & T6 & T7 & T8 & T9 & T10 & \begin{tabular}{c} 
Tpro \\
m
\end{tabular} \\
\hline$A_0 A_4$ & 14.93 & 14.03 & 14.38 & 14.84 & 14.82 & 14.24 & 13.73 & 13.56 & 13.89 & 14.02 & 14.24 \\
\hline
\end{tabular}
...
Experimento 2:
Estos datos fueron recogidos a una altura inicial $G_0=6.53 \mathrm{~cm}$ y final $G_0=2.95 \mathrm{~cm}$
\begin{tabular}{|l|l|l|l|l|l|l|l|l|l|l|l|}
\hline & T1 & T2 & T3 & T4 & T5 & T6 & T7 & T8 & T9 & T10 & \begin{tabular}{l} 
Tpro \\
m
\end{tabular} \\
\hline$A_0 A_4$ & 17.03 & 16.85 & 15.45 & 17.48 & 15.14 & 14.90 & 16.19 & 15.26 & 15.10 & 15.78 & 15.91 \\
\hline
\end{tabular}
